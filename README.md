# Linux CUPS Driver for Gprinter GP-1134T
...
3. 编辑 `/usr/share/cups/usb/org.cups.usb-quirks` and add the text in this repository's `org.cups.usb-quirks` to the bottom.
...
# 热转印打印机 CUPS 驱动（Linux）



源自 https://tifan.net/blog/2018/03/27/gprinter-thermal-printer-unix-driver/
